...
- 復能全壘打 (baseball-hit, moving) — 2026-07-19：沿用 useSlashDetector，第一人稱打擊時機遊戲。球種（直球/變速球/曲球/蝴蝶球/快速球）依難度開放；曲球彎曲/蝴蝶球飄忽以「有界視覺偏移」疊加在 hook 原生拋物線上（不改 hook，偏移 < 判定半徑）。calm 場景＋原創 CSS/inline-SVG 球與投手剪影。⚠️ 臨床審核待簽（見 §8）。
