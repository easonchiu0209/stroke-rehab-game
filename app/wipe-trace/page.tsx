...
function PlayingView({
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-900 select-none game-play-screen game-theme-orchard">
...
export default function WipeTracePage() {
  ...
  if (phase === 'config') {
    return (
      <main className="min-h-screen flex flex-col items-center px-5 py-10 gap-7 bg-gradient-to-b from-orange-50 to-gray-50 game-menu-screen game-theme-orchard">
  ...
  return (
    <main className="min-h-screen flex flex-col items-center px-5 py-10 gap-6 bg-gradient-to-b from-orange-50 to-gray-50 game-menu-screen game-theme-orchard">
