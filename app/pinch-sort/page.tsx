...
function ConfigView({ difficulty, setDifficulty, onStart }: {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-amber-50 to-orange-100 flex flex-col items-center px-5 py-10 gap-6 game-menu-screen game-theme-kitchen">
...
function PlayingView({ difficulty, onEnd }: {
  ...
  return (
    <div className="w-full h-screen flex flex-col overflow-hidden game-play-screen game-theme-kitchen" style={{ background: '#fff7ed' }}>
